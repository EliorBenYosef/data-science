...
def plot_accuracies(trained_models, title):
    ...
    plt.show()
    # fig.savefig('DL15_testing_models_accuracy' + title + '.jpg')
    plt.close(fig)
...
def plot_losses(trained_models, title):
    ...
    plt.show()
    # fig.savefig('DL15_testing_models_loss' + title + '.jpg')
    plt.close(fig)
...
trained_models = [
    ...
    ('L1 0.0001 (1)', trained_model_overfit_reg01),
    ('L1 0.0001 (2)', trained_model_overfit_reg02),
    ('L1 0.0001 (3)', trained_model_overfit_reg03),
    ('L1 0.0001 (4)', trained_model_overfit_reg04)
]
...
trained_models = [
    ('Fit', trained_model),
    ('Overfit', trained_model_overfit),
    ('L2 0.0001 (1)', trained_model_overfit_reg01),
    ('L2 0.0001 (2)', trained_model_overfit_reg02),
    ('L2 0.0001 (3)', trained_model_overfit_reg03),
    ('L2 0.0001 (4)', trained_model_overfit_reg04)
]
...
trained_models = [
    ('Fit', trained_model),
    ('Overfit', trained_model_overfit),
    ('Dropout (0.05)', trained_model_overfit_reg01),
    ('Dropout (0.10)', trained_model_overfit_reg02),
    ('Dropout (0.15)', trained_model_overfit_reg03),
    ('Dropout (0.20)', trained_model_overfit_reg04),
    ('Dropout (0.25)', trained_model_overfit_reg05),
    ('Dropout (0.30)', trained_model_overfit_reg06)
]
